...
uint64_t aSRC_Buffer[BUFFER_SIZE_IN_BYTES/8]  __attribute__((section(".noncacheable"))) =
{
...
#pragma location=0x340E0000
uint64_t aIntermediate_Buffer[BUFFER_SIZE_IN_BYTES/8] __attribute__((section(".noncacheable"))) = {0};

/* Final destination buffer in SRAM2 */
uint64_t aDST_Buffer[BUFFER_SIZE_IN_BYTES/8] __attribute__((section(".noncacheable"))) = {0};
