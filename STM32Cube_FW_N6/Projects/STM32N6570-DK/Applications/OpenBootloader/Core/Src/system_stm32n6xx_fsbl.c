...
#define VECT_TAB_BASE_ADDRESS   0x34180400 /*!< Vector Table base address field.
...
void SystemInit(void)
{
  ...
  SYSCFG->VDDIO1CCCR = 0x00000278UL; /* SDMMC1 domain compensation */
  SYSCFG->VDDIO2CCCR = 0x00000278UL; /* SDMMC2 domain compensation */
  SYSCFG->VDDIO3CCCR = 0x00000278UL; /* Hexa-SPI domain compensation */
  SYSCFG->VDDIO4CCCR = 0x00000278UL; /* Octo-SPI domain compensation */
