...
static rtl8211_IOCtx_t  RTL8211EG_IOCtx = { rtl8211eg_io_init,
                                          rtl8211eg_io_deinit,
...
static rtl8211_Object_t RTL8211EG;
...
int32_t nx_eth_phy_init(void)
{
    ...
    RTL8211_RegisterBusIO(&RTL8211EG, &RTL8211EG_IOCtx);
    /* Initialize the RTL8211EG ETH PHY */

    if (RTL8211_Init(&RTL8211EG) == RTL8211_STATUS_OK)
    {
...
{
   return (RTL8211_SetLinkState(&RTL8211EG, LinkState));
}
...
{
    int32_t  linkstate = RTL8211_GetLinkState(&RTL8211EG);
