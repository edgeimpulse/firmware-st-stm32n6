...
static struct ext_flash_range access_vect[] =
{
  ...
  { S_DATA_IMAGE_SECONDARY_PARTITION_OEFFSET, S_DATA_IMAGE_SECONDARY_PARTITION_OFFSET + FLASH_S_DATA_PARTITION_SIZE - 1},
...
struct low_level_ext_flash_device FLASH0_DEV =
{
