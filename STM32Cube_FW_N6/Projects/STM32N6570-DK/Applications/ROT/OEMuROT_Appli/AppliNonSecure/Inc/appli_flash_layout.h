...
#define FLASH_AREA_END_OFFSET           (0x100000)
...
#define FLASH_AREA_3_OFFSET            0xBE000  /* Non-Secure app image secondary slot */

#define FLASH_AREA_3_SIZE              0x6000   /* Non-Secure app image secondary slot size */                                                    
...
#define FLASH_AREA_6_OFFSET            0x0 /* Non-secure data image secondary slot offset */

#define FLASH_AREA_6_SIZE              0x0   /* Non-secure data image secondary slot size */
