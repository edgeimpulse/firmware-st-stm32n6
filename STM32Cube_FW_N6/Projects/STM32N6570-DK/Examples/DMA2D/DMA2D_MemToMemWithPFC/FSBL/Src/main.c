...
static void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.AccumulatedActiveW = RK050HR18_HSYNC + RK050HR18_WIDTH + RK050HR18_HBP -1;
  hltdc.Init.TotalWidth         = RK050HR18_HSYNC + RK050HR18_WIDTH + RK050HR18_HBP + RK050HR18_HFP - 1;
  hltdc.Init.VerticalSync       = RK050HR18_VSYNC - 1;
  hltdc.Init.AccumulatedVBP     = RK050HR18_VSYNC + RK050HR18_VBP - 1;
  hltdc.Init.AccumulatedActiveH = RK050HR18_VSYNC + RK050HR18_HEIGHT + RK050HR18_VBP -1 ;
  hltdc.Init.TotalHeigh         = RK050HR18_VSYNC + RK050HR18_HEIGHT + RK050HR18_VBP + RK050HR18_VFP - 1;
