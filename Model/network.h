...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "trained"
...
// Output buffer 1 -- Transpose_597_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (24696)
