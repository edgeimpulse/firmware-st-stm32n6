...
int32_t yolov5_pp_nmsFiltering_centroid(postprocess_out_t *pOutput,
...
int32_t yolov5_pp_scoreFiltering_centroid(postprocess_out_t *pOutput,
                                          yolov5_pp_static_param_t *pInput_static_param)
{
    int32_t det_count = 0;
                                      ...
                                      yolov5_pp_static_param_t *pInput_static_param)
{
    ...
    for (int32_t i = 0; i < nb_total_boxes; i++)
    {
        ...
        {
            objdetect_maxi(&pRaw_detections[i*detection_len + AI_YOLOV5_PP_CLASSPROB],
                            nb_classes,
                            &best_score,
                            &class_index);
                                      ...
                                      yolov5_pp_static_param_t *pInput_static_param)
{
    ...
    if (scale <= 0.0f) {
        return AI_OBJDETECT_POSTPROCESS_ERROR;
    }
    ...
    for (int32_t i = 0; i < nb_total_boxes; i++)
    {
        ...
        {
            objdetect_maxi_uint8(&pRaw_detections[i*detection_len + AI_YOLOV5_PP_CLASSPROB],
                                 nb_classes,
                                 &best_score,
                                 &class_index);
