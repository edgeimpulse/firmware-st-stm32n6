...
const ei_config_aton_graph_t ei_config_graph_6 = {
...
ei_fill_result_object_detection_i8_config_t ei_fill_result_object_detection_i8_config_6 = {
    .threshold = 0.5,
    .version = 6,
    .object_detection_count = 10,
    .output_features_count = 24696,
    .zero_point = 3,
    .scale = 0.009093585424125195,
...
const ei_postprocessing_block_t ei_postprocessing_blocks[ei_postprocessing_blocks_size] = {
    {
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_object_detection_i8_config_6,
        .input_block_id = 6
    },
};
...
const ei_impulse_t impulse_374487_0 = {
    .project_id = 374487,
    .project_owner = "stm-internal",
    .project_name = "conference-dataset-person-logo-only",
    .impulse_id = 1,
    .impulse_name = "yolov5n-no-freeze 224",
    .deploy_version = 56,
    ...
    .output_tensors_size = ei_learning_blocks_size,
